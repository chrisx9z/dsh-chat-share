 ...
 */
export declare function chatShareRowMenuAction(open: (sessionId: SessionId) => Promise<void>, menuLabel: () => string): SessionRowMenuAction;
/**
 ...
 * @returns the registry action descriptor.
 */
export declare function chatShareSaveTxtMenuAction(saveTxt: (sessionId: SessionId) => Promise<void>, menuLabel: () => string): SessionRowMenuAction;
